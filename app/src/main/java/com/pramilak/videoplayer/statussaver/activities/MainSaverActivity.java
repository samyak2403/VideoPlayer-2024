package com.pramilak.videoplayer.statussaver.activities;
...
import com.pramilak.videoplayer.statussaver.fragment.RecentWapp;
import com.pramilak.videoplayer.statussaver.fragment.RecentWappBus;
import com.pramilak.videoplayer.statussaver.util.SharedPrefs;
import com.pramilak.videoplayer.statussaver.util.Utils;
...
public class MainSaverActivity extends AppCompatActivity {
...
//    private SlidingRootNav slidingRootNav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setLanguage(MainSaverActivity.this, SharedPrefs.getLang(MainSaverActivity.this));
...
//                navigate(null);
                ...
                if (tab.getPosition() == 0) {
                    if (isOpenWapp) {
                        isOpenWapp = false;
                        if (!SharedPrefs.getWATree(MainSaverActivity.this).equals("")) {
                            ((RecentWapp) MainSaverActivity.this.getSupportFragmentManager().findFragmentByTag("android:switcher:" + viewPager.getId() + ":" + tab.getPosition())).populateGrid();
                        }
                    }
                }
                if (tab.getPosition() == 1) {
                    if (isOpenWbApp) {
                        isOpenWbApp = false;
                        if (!SharedPrefs.getWBTree(MainSaverActivity.this).equals("")) {
                            ((RecentWappBus) MainSaverActivity.this.getSupportFragmentManager().findFragmentByTag("android:switcher:" + viewPager.getId() + ":" + tab.getPosition())).populateGrid();
                        }
                    }
                }
            }
...
//            AdController.inItIron(MainSaverActivity.this);
//        } else {
//            /*admob*/
//            AdController.loadBannerAd(MainSaverActivity.this, container);
//            AdController.loadInterAd(MainSaverActivity.this);
//        }
...
//            AdController.ironBanner(MainSaverActivity.this, container);
...
//    }
    ...
    void wAppAlert() {
        dialog = new Dialog(MainSaverActivity.this);
        ...
        btnWapp.setOnClickListener(arg0 -> {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(MainSaverActivity.this, "Please Install WhatsApp For Download Status!!!!!", Toast.LENGTH_SHORT).show();
            }
            dialog.dismiss();
        ...
        btnWappBus.setOnClickListener(arg0 -> {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(MainSaverActivity.this, "Please Install WhatsApp Business For Download Status!!!!!", Toast.LENGTH_SHORT).show();
            }
            dialog.dismiss();
        });
    ...
    void langAlert() {
        dialogLang = new Dialog(MainSaverActivity.this);
        ...
        txtEn.setOnClickListener(arg0 -> {
            SharedPrefs.setLang(MainSaverActivity.this, "en");
            dialogLang.dismiss();
            refresh();
        });

        txtHi.setOnClickListener(arg0 -> {
            SharedPrefs.setLang(MainSaverActivity.this, "hi");
            dialogLang.dismiss();
            refresh();
        });

        txtAr.setOnClickListener(arg0 -> {
            SharedPrefs.setLang(MainSaverActivity.this, "ar");
            dialogLang.dismiss();
            refresh();
        });
    ...
    public View getTabView(int pos) {
        View v = LayoutInflater.from(MainSaverActivity.this).inflate(R.layout.custom_tab, null);
        TextView txt = v.findViewById(R.id.tab);
...
//        }
    ...
    void setPress(ImageView imageView, TextView textView, int color) {
        imageView.setColorFilter(ContextCompat.getColor(MainSaverActivity.this, color), android.graphics.PorterDuff.Mode.SRC_IN);
...
//
//                    navigate(new Intent(MainSaverActivity.this, MyStatusActivity.class));
//
//
//                    slidingRootNav.closeMenu();
//                    break;
...
//
//                    navigate(new Intent(MainSaverActivity.this, WAWebActivity.class));
//
//
//                    slidingRootNav.closeMenu();
//                    break;
...
//
//                    navigate(new Intent(MainSaverActivity.this, DChatActivity.class));
//
//
//                    slidingRootNav.closeMenu();
//                    break;
...
//
//                    navigate(new Intent(MainSaverActivity.this, FontActivity.class));
//
//
//                    slidingRootNav.closeMenu();
//                    break;
...
//
//
//                    navigate(new Intent(MainSaverActivity.this, DeletedMsgActivity.class));
//
//
//                    slidingRootNav.closeMenu();
//                    break;
...
//                    startActivity(new Intent(MainSaverActivity.this, HelpActivity.class));
//                    slidingRootNav.closeMenu();
//                    break;
//
//                case R.id.nShare:
...
//                    slidingRootNav.closeMenu();
//                    startActivity(new Intent(MainSaverActivity.this, PolicyActivity.class));
//                    break;
//
//            }
        }
...
//        if (AdController.isLoadIronSourceAd) {
//            AdController.ironShowInterstitial(MainSaverActivity.this, intent, 0);
//        } else {
//            AdController.showInterAd(MainSaverActivity.this, intent, 0);
//        }
//    }
    ...
    public void onBackPressed() {
        if (System.currentTimeMillis() - mLastBackClick < 1100) {
            ...
            Toast.makeText(MainSaverActivity.this, getResources().getString(R.string.exit_alert), Toast.LENGTH_SHORT).show();
