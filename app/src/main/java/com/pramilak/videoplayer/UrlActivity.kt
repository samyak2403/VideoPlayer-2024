...
import com.pramilak.videoplayer.databinding.ActivityUrlBinding
                ...
                if (checkForInternet(this)) {
                    ...
                    if (url.isNotEmpty() && isValid) {
                        if (url.contains("youtu", true)) {
                            Snackbar.make(
                                binding.root,
                                "Use Youtube Feature To Play It. \uD83D\uDC49",
                                5000
                            )
                                .setAction("Play") {
                            ...
                            if (URLUtil.isFileUrl(url)) {
                                ...
                                Snackbar.make(
                                    binding.root,
                                    "Use Browser Feature To Play It. \uD83D\uDC49",
                                    5000
                                )
                                    .setAction("Play") {
                                        val builder = CustomTabsIntent.Builder()
                        ...
                        binding.root,
                        "Enter A Proper Link First!! \uD83D\uDE03",
                        3000
                    )
                        .show()
                } else Snackbar.make(binding.root, "\uD83C\uDF10 Internet Not Connected.", 3000)
                    .show()
            })
